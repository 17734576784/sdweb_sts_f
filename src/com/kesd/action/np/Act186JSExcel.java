...
public class Act186JSExcel {
	...
	private boolean loadJsRtuMpPara()
	{
		...
		String sql_cmd = "select res.cons_no,mt.made_no, c.rtu_id, c.id mp_id,c.bak_flag,d.power_relaf,d.power_rela1,d.power_rela2,d.cacl_type, d.feectrl_type, d.pay_type, e.cus_state " + 
						 "from conspara as a, rtupara as b, mppara as c, mppay_para as d, mppay_state as e,residentpara res,meterpara mt " + 
						 "where b.app_type = 3 and b.cons_id = a.id and c.rtu_id = b.id and d.rtu_id=b.id and e.rtu_id=b.id and e.mp_id=c.id " + 
						 "and res.rtu_id = b.id and mt.rtu_id=b.id and mt.mp_id=c.id and mt.resident_id=res.id and d.mp_id=c.id and mt.use_flag=1 " +
						 "and c.use_flag=1 and mt.prepayflag=1 order by c.rtu_id, c.mp_id";
	...
	public String getOneCons(){
		...
		String sql = "select res.id res_id,res.address cons_addr,mt.meter_id,res.mobile cons_telno,c.wiring_mode,mt.factory,c.pt_ratio*c.ct_ratio blv," +
