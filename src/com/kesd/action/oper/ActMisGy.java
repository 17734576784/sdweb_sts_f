...
public class ActMisGy extends ActionSupport{
	...
	private String MIS_GyQueryPower(String user_name, ComntParaBase.RTU_PARA rtu_para, ComntParaBase.OpDetailInfo op_detail, 
		...
		ComntMsgMis.YFFMISMSG_GY_QUERYPOWER 		power_query  = new ComntMsgMis.YFFMISMSG_GY_QUERYPOWER();
		ComntMsgMis.YFFMISMSG_GY_QUERYPOWER_RESULT  power_result = new ComntMsgMis.YFFMISMSG_GY_QUERYPOWER_RESULT();
		...
		ret_val = ComntOperMis.GYQueryPower(user_name, i_user_data1, i_user_data2, rtu_para, p_zjg_id, 
			...
			if(power_result.retcode != ComntMsgMis.YFFMIS_MISOP_OKNO){
				...
				//MIS返回错误
					...
					misResult = "MIS用户查询失败, \n错误信息:" + err_str_1 + " , \nMIS错误信息:" + 
								...
								ComntOperMis.GetMisErrStr(power_result.retcode) + " \n不能操作...";
				}
			}
			else {
	...
	//高压操作-缴费记录上传	
	private String MIS_GyPay(String user_name, ComntParaBase.RTU_PARA rtu_para, 
		...
		//发送
		ComntMsgMis.YFFMISMSG_GY_PAY pay_req = new ComntMsgMis.YFFMISMSG_GY_PAY();
		ComntMsgMis.YFFMISMSG_GY_PAY_RESULT  pay_result = new ComntMsgMis.YFFMISMSG_GY_PAY_RESULT();
		...
		//上传缴费记录
		task_result_detail.clear(); err_str_1.setLength(0);
		ret_val = ComntOperMis.GYPay(user_name, i_user_data1, i_user_data2, rtu_para, p_zjg_id, 
		...
		//返回错误 读数据库
			...
			//容错处理
			Map<String, String> map = DBOperMis.loadOneZYffMisPayRecord(/*p_rtu_id, p_zjg_id, */p_date, p_wasteno);
			if ((map != null) && 
	...
	//高压操作-冲正
	private String MIS_GYRever(String user_name, ComntParaBase.RTU_PARA rtu_para, 
								ComntParaBase.OpDetailInfo op_detail, StringBuffer err_str_1, 
								ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
		...
		//上传冲正记录
		ComntMsgMis.YFFMISMSG_GY_REVER 		   rever_req    = new ComntMsgMis.YFFMISMSG_GY_REVER();
		ComntMsgMis.YFFMISMSG_GY_REVER_RESULT  rever_result = new ComntMsgMis.YFFMISMSG_GY_REVER_RESULT();
		...
		task_result_detail.clear(); err_str_1.setLength(0);
		ret_val = ComntOperMis.GYRever(user_name, i_user_data1, i_user_data2, rtu_para, p_zjg_id, 
		...
		if (ret_val) {
			...
			Map<String, String> map_rev_record = DBOperMis.loadOneZYffMisReverRecord(p_date, p_rewasteno);
		...
		//MIS查询
		ComntMsgMis.YFFMISMSG_GY_QUERYPOWER power_req = new ComntMsgMis.YFFMISMSG_GY_QUERYPOWER();
	...
	//高压操作-检查缴费
	private String MIS_GYCheckPay(String user_name, ComntParaBase.RTU_PARA rtu_para, 
								ComntParaBase.OpDetailInfo op_detail, StringBuffer err_str_1, 
								ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
		...
		//读取MIS缴费操作记录
		Map<String, String> mis_payrcd = DBOperMis.loadOneZYffMisPayRecord(/*p_rtu_id, p_zjg_id, */p_opdate, p_wasteno);
		if ((mis_payrcd != null) && 
	...
	//高压操作-检查冲正
	private String MIS_GYCheckRever(String user_name, ComntParaBase.RTU_PARA rtu_para, 
								ComntParaBase.OpDetailInfo op_detail, StringBuffer err_str_1, 
								ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
		...
		//读取MIS冲正操作记录
		Map<String, String> mis_reverrcd = DBOperMis.loadOneZYffMisPayRecord(/*p_rtu_id, p_zjg_id, */p_opdate, p_wasteno);
		...
		if (ret_val) {
			...
			Map<String, String> map_rev_record = DBOperMis.loadOneZYffMisReverRecord(p_opdate, p_wasteno);
			if ((map_rev_record != null) && 
				(CommBase.strtoi(map_rev_record.get("error_no")) == ComntMsgMis.YFFMIS_MISOP_OKNO)) {
				rev_ok_flag = true;
			}
...
//*********************************************河北MIS结束*************************************************
	...
	//*********************************************河南MIS开始*************************************************
	//河南高压操作-查询缴费
	private String MIS_GyQueryPower_HN(String user_name, ComntParaBase.RTU_PARA rtu_para, ComntParaBase.OpDetailInfo op_detail, 
			StringBuffer err_str_1, ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
		...
		ComntMsgMisHN.YFFMISMSG_GY_QUERYPOWER_HN 		power_query  = new ComntMsgMisHN.YFFMISMSG_GY_QUERYPOWER_HN();
		ComntMsgMisHN.YFFMISMSG_GY_QUERYPOWER_RESULT_HN  power_result = new ComntMsgMisHN.YFFMISMSG_GY_QUERYPOWER_RESULT_HN();
		...
		task_result_detail.clear(); err_str_1.setLength(0);
		ret_val = ComntOperMisHN.GYQueryPower(user_name, i_user_data1, i_user_data2, rtu_para, p_zjg_id, 
											power_query, power_result, task_result_detail, err_str_1);
	...
	//河南高压操作-缴费记录上传	
	private String MIS_GyPay_HN(String user_name, ComntParaBase.RTU_PARA rtu_para, 
						  ComntParaBase.OpDetailInfo op_detail, StringBuffer err_str_1, 
						  ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
		...
		//发送
		ComntMsgMisHN.YFFMISMSG_GY_PAY_HN pay_req = new ComntMsgMisHN.YFFMISMSG_GY_PAY_HN();
		ComntMsgMisHN.YFFMISMSG_GY_PAY_RESULT_HN  pay_result = new ComntMsgMisHN.YFFMISMSG_GY_PAY_RESULT_HN();
		...
		int len = CommBase.strtoi(json.getString("vlength"));
		pay_req.details_vect = new ComntMsgMisHN.YFFMISMSG_GY_PAY_HN.POWERPAY_DETAIL[len];
		for(int j = 0; j < len; j++){
			pay_req.details_vect[j] = new ComntMsgMisHN.YFFMISMSG_GY_PAY_HN.POWERPAY_DETAIL();
		...
		//上传缴费记录
		task_result_detail.clear(); err_str_1.setLength(0);
		ret_val = ComntOperMisHN.GYPay(user_name, i_user_data1, i_user_data2, rtu_para, p_zjg_id, 
											pay_req, pay_result, task_result_detail, err_str_1);
		...
		if(payok_flag == false) {
			...
			//MIS返回错误
				...
				misResult = "上传缴费记录失败, \n错误信息:" + err_str_1 + " , \nMIS错误信息:" + 
							pay_result.retcode + ": " +
							ComntOperMisHN.GetMisErrStr(pay_result.retcode) + " \n请转入【补MIS缴费记录】页面...";
			}
		}
		else {
			misResult = "上传缴费记录成功。";
	...
	//河南高压操作-冲正
	private String MIS_GYRever_HN(String user_name, ComntParaBase.RTU_PARA rtu_para, 
								ComntParaBase.OpDetailInfo op_detail, StringBuffer err_str_1, 
								ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
		...
		//上传冲正记录
		ComntMsgMisHN.YFFMISMSG_GY_REVER_HN 		   rever_req    = new ComntMsgMisHN.YFFMISMSG_GY_REVER_HN();
		ComntMsgMisHN.YFFMISMSG_GY_REVER_RESULT_HN  rever_result = new ComntMsgMisHN.YFFMISMSG_GY_REVER_RESULT_HN();
		...
		task_result_detail.clear(); err_str_1.setLength(0);
		ret_val = ComntOperMisHN.GYRever(user_name, i_user_data1, i_user_data2, rtu_para, p_zjg_id, 
									rever_req, rever_result, task_result_detail, err_str_1);			
		...
		if (!rev_ok_flag) {
			...
			//MIS返回错误
				...
				misResult = "上传冲正记录失败, \n错误信息:" + err_str_1 + " , \nMIS错误信息:" +
							rever_result.retcode + ": " +
							ComntOperMisHN.GetMisErrStr(rever_result.retcode) + " \n请转入【补MIS冲正记录】页面...";
			}
			return SDDef.FAIL;
		}
		...
		//MIS查询
		ComntMsgMisHN.YFFMISMSG_GY_QUERYPOWER_HN power_req = new ComntMsgMisHN.YFFMISMSG_GY_QUERYPOWER_HN();
		...
		if (ret_val == false || power_result.retcode != ComntMsgMisHN.YFFMIS_MISOP_OKNO) {
			if (task_result_detail.errcode == 0) {
				...
				misResult = "MIS用户查询失败, \n错误信息:" + err_str_1 + ", \nMIS错误信息:" + 
							task_result_detail.errcode + ": " +
							ComntOperMisHN.GetMisErrStr(task_result_detail.errcode) + " \n请转入【补MIS缴费记录】页面...";
			}
		...
		ComntFunc.string2Byte(batch_no, pay_req.batch_no);
		//欠费信息
		pay_req.details_vect = new ComntMsgMisHN.YFFMISMSG_GY_PAY_HN.POWERPAY_DETAIL[pay_req.jfbs];
		for(int j = 0; j < pay_req.jfbs; j++){
			pay_req.details_vect[j] = new ComntMsgMisHN.YFFMISMSG_GY_PAY_HN.POWERPAY_DETAIL();
			ComntFunc.arrayCopy(pay_req.details_vect[j].ysbs, power_result.details_vect[j].ysbs);
		}
	...
	//河南高压操作-检查缴费
	private String MIS_GYCheckPay_HN(String user_name, ComntParaBase.RTU_PARA rtu_para, 
								ComntParaBase.OpDetailInfo op_detail, StringBuffer err_str_1, 
								ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
	...
	//河南高压操作-检查冲正
	private String MIS_GYCheckRever_HN(String user_name, ComntParaBase.RTU_PARA rtu_para, 
								ComntParaBase.OpDetailInfo op_detail, StringBuffer err_str_1, 
								ComntParaBase.SALEMAN_TASK_RESULT_DETAIL task_result_detail) throws Exception {
		...
		try {
			...
			//河南MIS add----------
				...
				if (userop_id == ComntUseropDef.YFF_GYOPER_MIS_QUERYPOWER) {			//高压操作-MIS查询缴费
					...
					ret_val = MIS_GyQueryPower_HN(user_name, rtu_para, op_detail, err_str_1, task_result_detail);
				}
				else if (userop_id == ComntUseropDef.YFF_GYOPER_MIS_PAY) {				//高压操作-MIS缴费记录上传
					
					ret_val = MIS_GyPay_HN(user_name, rtu_para, op_detail, err_str_1, task_result_detail);
				}
				else if (userop_id == ComntUseropDef.YFF_GYOPER_MIS_REVER) {			//高压操作-MIS冲正操作
					
					ret_val = MIS_GYRever_HN(user_name, rtu_para, op_detail, err_str_1, task_result_detail);
				}
				else if (userop_id == ComntUseropDef.YFF_GYOPER_MIS_CHECKPAY) {			//高压操作-MIS检查缴费
					
					ret_val = MIS_GYCheckPay_HN(user_name, rtu_para, op_detail, err_str_1, task_result_detail);
				}
				else if (userop_id == ComntUseropDef.YFF_GYOPER_MIS_CHECKREVER) {		//高压操作-MIS检查冲正
					
					ret_val = MIS_GYCheckRever_HN(user_name, rtu_para, op_detail, err_str_1, task_result_detail);			
				}
				else {
					op_detail.addTaskInfo("ERR:未知的操作类型[" + userop_id + "]");
				}
	...
	public String misErrSearch(){
		...
		try{
			...
			for (int i = 0; i < year_num; i++, isdate++) {
				String table_name = "yddataben.dbo.zyff" + isdate;
				String sql = "";
				if(err_type.equals("0")) {		//所有失败记录
					sql = "select b.rtu_id, b.zjg_id, r.rtu_model as rtu_model, r.prot_type as prot_type, b.wasteno, b.rewasteno, "
							+ "a.busi_no as cons_no,a.describe,a.addr,b.op_type,b.op_date,b.op_time,b.op_man,b.pay_type,b.pay_money,"
							+ "b.othjs_money,b.zb_money,b.all_money, b.shutdown_val,b.buy_times, b.sg186_ysdw, b.up186_flag, b.checkpay_flag "
							+ "from ydparaben.dbo.conspara a, ydparaben.dbo.rtupara as r, " + table_name + " b where r.cons_id = a.id  and r.id = b.rtu_id "
							+ "and b.op_date>="+sdate+" and b.op_date<="+edate+" and b.visible_flag=1 and b.up186_flag=1 and b.checkpay_flag=0";
				}
					...
					sql = "select b.rtu_id, b.zjg_id, r.rtu_model as rtu_model, r.prot_type as prot_type, b.wasteno, b.rewasteno, "
						...
						+ "b.othjs_money,b.zb_money,b.all_money, b.shutdown_val,b.buy_times, b.sg186_ysdw, b.up186_flag, b.checkpay_flag "
						+ "from ydparaben.dbo.conspara a, ydparaben.dbo.rtupara as r, " + table_name + " b where r.cons_id = a.id  and r.id = b.rtu_id "
						+ "and b.op_date>="+sdate+" and b.op_date<="+edate+" and b.visible_flag=1 and b.op_type <> " + SDDef.YFF_OPTYPE_REVER + " and b.up186_flag=1 and b.checkpay_flag=0";
				}
				...
				try{
					...
					while(rs.next()) {
						...
						ret.append("{id:\"" + rs.getInt("rtu_id")+"_"+rs.getInt("zjg_id")+"_"+rs.getString("wasteno") + "\",data:[" + ++count +",");
						//用户编号
						...
						//用户地址
						ret.append("\"" + CommBase.CheckString(rs.getString("addr")) + "\",");
						//上传标志
