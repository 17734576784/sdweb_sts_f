...
//				 "报警1短信时间,报警1声音时间,分合闸发送时间,报警2短信时间,报警2声音时间,成功分合闸时间,报警1短信UUID,报警2短信UUID,信息输出";
	var header = "ID,Terminal,Customer ID,Meter Desc,Meter No,Customer Name,FeeType,FeectrlType,ChargeType,Tariff Type,KRN,Customer State,OperType,OperDate,Payment amount,Transfer Credit,Purchase Count,Opening Date,Info "
