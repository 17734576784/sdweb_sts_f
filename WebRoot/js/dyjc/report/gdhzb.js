...
function initgrid(){
	...
	mygrid.setInitWidths("50,120,200,80,150,150,150,*");
	...
	$("#filename").val(encodeURI("PurchaseSummary"));
...
function search(){
	...
	$.post(def.basePath + "ajaxdyjc/actReport!gdhzReport.action",{result : param},function(data){
		loading.loaded();
		if(data.result != ""){
