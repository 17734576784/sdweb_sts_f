...
function selcons(){//检索
	var tmp = doSearch("zz",ComntUseropDef.YFF_GYOPER_CHANGEMETER, rtnValue);
	if(!tmp){
		return;
	}
	rtnValue = tmp;
...
function IsDisabled(){
	...
	$("#btnChgmeter").attr("disabled",true);
	$("#chg_time").attr("disabled",true);
	$("#chg_meter").attr("disabled",true);
	$("#ctfz").attr("readonly",true).css("background","#ccc");
	$("#ctfm").attr("readonly",true).css("background","#ccc");
	$("#ptfz").attr("readonly",true).css("background","#ccc");
	$("#ptfm").attr("readonly",true).css("background","#ccc");
...
function UnDisabled() {
	...
	rtnBDOld = null;
	rtnBDNew = null;
	$("#chg_time").attr("disabled",false);
	$("#chg_meter").attr("disabled",false);
