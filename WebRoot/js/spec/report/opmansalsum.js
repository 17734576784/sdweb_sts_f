...
function initgrid(){
	...
	mygrid.setColAlign("center,center,center,right,right,right,right,right");
...
function search(){
	...
	$.post(def.basePath + "ajaxspec/actReport!opmanSalsumReport.action",{result : param},function(data){
		loading.loaded();
		if(data.result != ""){
