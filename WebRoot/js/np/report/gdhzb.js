...
function initgrid(){
	...
	mygrid.setInitWidths("50,120,140,80,120,120,120,120,*");
	...
	$("#filename").val(encodeURI("农排购电汇总表"));
...
function search(){
	...
	$.post(def.basePath + "ajaxnp/actReport!gdhzReport.action",{result : param},function(data){
		loading.loaded();
		if(data.result != ""){
