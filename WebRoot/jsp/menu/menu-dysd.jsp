...
<html>
  <head>
    ...
    <title>Low voltage sale power</title>
  ...
  <table cellpadding="0" cellspacing="0"  border=0>
	  <tr>
		...
		<td id="tdright">
		  ...
		  <%
		  int i = 0;
		  out.println(Menu.getDy_localcard(yffman, i++));
		  out.println(Menu.getDy_localremote(yffman, i++));
		  out.println(Menu.getDy_main(yffman, i++));
		  out.println(Menu.getDy_localcardExt(yffman, i++));
		  out.println(Menu.getDy_search(yffman, i++));
		  out.println(Menu.getDy_report(yffman, i++));
		  out.println(Menu.getDy_tool(yffman, i++));
		  out.println(Menu.getDy_print(yffman, i++));
		  %>
		  </div>
		</td>
	  </tr>
