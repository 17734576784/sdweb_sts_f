  ...
  <table cellpadding="0" cellspacing="0"  border=0>
	  <tr>
		...
		<td id="tdright">
		  ...
		  if(ggda == null) ggda = 0;
		  if(ggda != 0) {
			  out.println(Menu.getDocPublic(yffman, i++));
		  }
		  out.println(Menu.getDocDy(yffman, i++));
		  out.println(Menu.getDocGy(yffman, i++));		  
		  out.println(Menu.getDocNp(yffman, i++));
		  %>
		  </div>
		</td>
	  </tr>
