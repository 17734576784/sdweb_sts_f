  ...
  <table cellpadding="0" cellspacing="0"  border=0>
	  <tr>
		...
		<td id="tdright">
		  ...
		  <%
		  int i = 0;
		  out.println(Menu.getNp_localcard(yffman, 	i++));
		  out.println(Menu.getNp_search(yffman, 	i++));
		  out.println(Menu.getNp_report(yffman, 	i++));
		  out.println(Menu.getNp_tool(yffman, 		i++));
		  out.println(Menu.getNp_print(yffman,		i++));
		  %>
		  </div>
		</td>
	  </tr>
