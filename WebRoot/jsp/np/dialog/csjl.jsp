...
<html>
  ...
  <script src="<%=basePath%>js/np/dialog/csjl.js"></script>
  ...
  <tr>
    <td style="margin:0 0 0 0; padding: 0 0 0 0;"><fieldset style="text-align: center;">
        ...
        <label for="chkmeterconf">[仅可召测]&nbsp;参数设置记录(50条)</label></legend>
	...
	ComntProtMsg.YFF_CALL_HNQF_CSJL_FIR		= <%=ComntProtMsg.YFF_CALL_HNQF_CSJL_FIR%>;
