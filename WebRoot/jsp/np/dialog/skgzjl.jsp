...
<html>
  ...
  <script src="<%=basePath%>js/np/dialog/skgzjl.js"></script>
  ...
  <tr>
    <td style="margin:0 0 0 0; padding: 0 0 0 0;"><fieldset style="text-align: center;">
        ...
        <label for="chkmeterconf">[仅可召测]&nbsp;刷卡故障记录(30条)</label></legend>
	...
	var ComntProtMsg = {};
	ComntProtMsg.YFF_CALL_DL645_GZJL_FIR = <%=ComntProtMsg.YFF_CALL_DL645_GZJL_FIR%>;
	var ComntUseropDef = {};
	ComntUseropDef.YFF_READDATA 		= <%=ComntUseropDef.YFF_READDATA%>;
	ComntProtMsg.YFF_CALL_HNQF_GZJL_FIR		= <%=ComntProtMsg.YFF_CALL_HNQF_GZJL_FIR%>;
