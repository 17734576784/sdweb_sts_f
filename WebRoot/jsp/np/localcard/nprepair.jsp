...
<html>
	<head>
		...
		<script  src="<%=basePath%>js/np/localcard/nprepair.js"></script>
	...
	<table id="tabinfo1" class="tabinfo" align="center">
    	...
    	<tr>
    		...
    		<td colspan=4 style="padding-left:10px; border: 0px;">
	    	<button id="btnRead"  class="btn" disabled>读卡</button>	
	    	</td>
	...
	<table id="tabinfo2" class="tabinfo" align="center">
	    ...
	    <tr>
		    <td class="tdr" width="12%">缴费金额(元):</td><td class="tdrn"><input type="text" id="pay_money"/></td>			
		    <td class="tdr" width="12%">追补金额(元):</td><td class="tdrn" width="20%"><input type="text" id="zb_money"/></td>
	    	<td class="tdr">结算金额(元):</td><td class="tdrn" ><input type="text" id="othjs_money"  /></td>
	    </tr>
	    <tr>
	  		<td class="tdr">总金额(元):	</td><td class="tdrn"><span  id="all_money" style="width: 100%"></span></td>
	  		<td class="tdr">上次缴费金额(元): </td><td class="tdrn"><span id="lastpay_money">&nbsp;</span></td>
	  		<td></td><td></td>
	    </tr>
	</table>
	...
	<script type="text/javascript">
		...
		ComntUseropDef.YFF_NPOPER_REPAIR     = <%=ComntUseropDef.YFF_NPOPER_REPAIR%>
