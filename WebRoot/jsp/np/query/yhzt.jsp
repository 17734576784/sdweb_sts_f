...
<html>
  <head>
	...
	<script  src="<%=basePath%>js/np/query/yhzt.js"></script>
  ...
  <body>
    ...
    <table id="tabinfo" class="tabinfo" align="center">
	    ...
	    <tr>
	     	...
	     	<td class="tdr">所属片区</td><td><select id="area"><option value="-1">所有</option></select></td>
	     	...
	     	<td class="tdr">移动电话</td><td><input type="text" id="lxdh"/></td>
	    </tr>
	    <tr>
