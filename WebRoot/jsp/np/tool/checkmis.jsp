...
<html>
  <head>
	...
	<script  src="<%=basePath%>js/dyjc/tool/checkmis.js"></script>
  ...
  <body>
    ...
    <jsp:include page="../../inc/jsdef.jsp" />
  	<SCRIPT>
		...
		var ComntUseropDef = {};
		ComntUseropDef.YFF_DYOPER_MIS_CHECKPAY 	= <%=ComntUseropDef.YFF_DYOPER_MIS_CHECKPAY%>;
		ComntUseropDef.YFF_DYOPER_MIS_CHECKREVER = <%=ComntUseropDef.YFF_DYOPER_MIS_CHECKREVER%>;
