...
<html>
  <head>
	...
	<script  src="<%=basePath%>js/np/report/dfce.js"></script>
    ...
    <table id="tabinfo" class="tabinfo" align="center">
    	<tr>
   		...
   		<tr>
	    	...
	    	<td class="tdr">供电所:</td><td><select id="org"></select></td>
	    	<td class="tdr">台区:</td><td><select id="cons"></select></td>
	    	<td class="tdr" >
