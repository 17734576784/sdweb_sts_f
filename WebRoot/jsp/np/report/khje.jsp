...
<html>
  <head>
    ...
    <title>My JSP 'khje.jsp' starting page</title>
	...
	<script  src="<%=basePath%>js/np/report/khje.js"></script>
    ...
    <table id="tabinfo" class="tabinfo" align="center">
    	<tr>
   		...
   		<tr>
	    	...
	    	<td class="tdr">客户名称:</td>
	     	<td><input type="text" id="khmc" /></td>
	     	<td class="tdr">客户编号:</td>
	     	<td><input type="text" id="khbh" /></td>
	     	<td class="tdr">卡号:</td><td><input type="text" id="cardno" /></td>
	    </tr>
	    <tr>
	    	<td class="tdr">营业点:</td><td><select id="org"></select></td>
	    	<td class="tdr">片区:</td><td><select id="area"></select></td>
	    	
	    	<td class="tdr">电表名称:</td><td><select id="meterdesc"><option value=-1>所有</option></select></td>
	    	<td class="tdr">电表地址:</td><td><input type="text" id="meteraddr" /></td>
	    </tr>
	    <tr>
