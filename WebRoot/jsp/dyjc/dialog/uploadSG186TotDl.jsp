...
<html>
  <head>
	...
	<script src="<%=basePath%>js/dyjc/dialog/uploadSG186TotDl.js"></script>
  ...
  <body>
	<form id="frmfile" name="frmfile" action="" style="display:inline" method ="POST" ENCTYPE="multipart/form-data"> 
	 <table cellpadding="0" cellspacing="0" align="center" class="mytable" >
		...
		<tr><td>年累计用电量:</td></tr>
		<tr><td><input type="file" name ="myFileDL" id="myFileDL" style="height:22px;" /></td></tr>
