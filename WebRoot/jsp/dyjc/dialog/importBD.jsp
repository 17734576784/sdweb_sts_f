...
<html>
	...
	<style type="text/css">
		...
		<script  src="<%=basePath%>js/dyjc/dialog/importBD.js"></script>
      ...
      <tr><td colspan="7" style="height:20px; border: 0px;"></td></tr>
	    ...
	    <tr>
	    	...
	    	<select id=dataType style="display:none;">
	    		<option value=<%=com.kesd.comnt.ComntProtMsg.YFF_CALL_REAL_ZBD%>>实时数据</option>
	    		<option value=<%=com.kesd.comnt.ComntProtMsg.YFF_CALL_DAY_ZBD%>>日冻结数据</option>
	    	</select>
