...
.d_cl{
  ...
  <table class="tabsty" align="center">
    ...
    <tr>      
      <td width="13%"><font color=red>*</font>终端名称:</td><td width="18%" class="inputimp"><input id="describe" /></td>
      <td width="14%">客户编号:      </td><td width="14%"  class="inputimp"><input id="cons_no" /></td> 
      <td width="16%">测量点名称: </td><td width="16%"  class="inputimp"><input id="mp_id" /></td>
    </tr>
    <tr>
      <td>ESAM表号:</td><td class="inputimp"><input id="meter_id" /></td>
      <td>客户名称:</td><td class="inputimp"><input id="cons_desc" /></td>
      <td></td><td></td>
    </tr>
    <tr>
