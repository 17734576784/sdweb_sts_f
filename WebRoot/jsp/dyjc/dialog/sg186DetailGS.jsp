...
<html>
	...
	<script  src="<%=basePath%>js/dyjc/dialog/sg186DetailGS.js"></script>
  ...
  <body>
   <table class="tabinfo" align="center" style="width:300px;">
      <tr><td colspan="2" style="height:20px; border: 0px;"></td></tr>
		...
		<tr><td class="tdr" >对账批次:</td><td id="dzpcNum"></td></tr>	 	
	 	<tr><td class="tdr" >应缴电费(元):</td><td id="yjAllMoney"> </td></tr>
	 	<tr><td class="tdr" >预收余额(元):</td><td id="ysAllMoney">	</td></tr>
	 	<tr><td class="tdr" >金额总笔数:</td><td id="TotalpayTimes"></td></tr>
	 	<tr><td class="tdr" >应收标识:</td><td id="ysbsNum"> </td></tr>
	 	<tr><td class="tdr" >电费年月:</td><td id="dfym">	</td></tr>
	 	<tr><td class="tdr" >应缴金额(元):</td><td id="yjmoney"> </td></tr>
	 	<tr><td class="tdr" >电费金额(元):</td><td id="dfmoney"> </td></tr>
