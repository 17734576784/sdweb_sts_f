...
<html>
	<head>
		<title>My JSP 'gybd.jsp' starting page</title>
		<style type="text/css">
		...
		<script  src="<%=basePath%>js/spec/tool/gyrmtctrl.js"></script>
	...
	<table id="tabinfo" class="tabinfo" align="center">
	   ...
	   <tr>
	    ...
	    <tr id="ctrlpara_content">
	    	...
	    	<td class="tdr">脉冲宽度(毫秒):</td><td><input type="text" id="plus_width" style="width: 80%" /></td>
	    	<td></td>
	    </tr>
	    <tr id="ctrlpara_butt"><td colspan="6" style="height:10px; border: 0px;"></td></tr>
    	<tr><td class="td_lable">控制类型</td></tr>
	   <tr>
	    	<td class="tdr">操作类型:</td>
	    	<td><select id="oper_type">
	    	</select></td>
	    	<td class="tdr">开关轮次:</td><td colspan=3>
	    	<select id="kglc"></select>
	    	</td>
	    </tr>
	   	<tr>
	    	<td class="tdr">保电开始:</td><td><input type="text" id="bdks"/>时</td>
	    	<td class="tdr">限电时长:</td><td colspan=3><select id="xdsc"></select></td>
	   	</tr>
	   	<tr>
	   		<td class="tdr">保电结束:</td><td><input type="text" id="bdjs" />时</td>
	   		<td class="tdr">延迟时间:</td><td colspan=3><input type="text" id="ycsj"/>分钟</td>
	    </tr>
	    <tr>
    	<td colspan="6" style="text-align: right;border: 0px;height:40px;">
	    	<button id="operation" class="btn" disabled="disabled">操作</button>
	    </td></tr>
	    </table>
