...
<html>
	<head>
		...
		<script  src="<%=basePath%>js/spec/localbd/gychgmeter.js"></script>
	...
	<table id="tabinfo2" class="tabinfo" align="center">
    	...
    	<tr><td colspan=6 style="border: 0px;padding: 0 0 0 0;">
    	<table class="tabinfo" style="width: 100%;" cellpadding="0" cellspacing="0">
    	<tr >
	    	<td class="tdr" width="10%">剩余金额(元):</td><td width="10%" class="tdrn"><input id="syje" /></td>
    	...
    	<tr>
	    	<td class="tdr" width="10%">更换时间:</td><td width="20%">
	    	...
	    	<td class="tdr" width="10%">更换电表:</td><td class="tdrn" width="20%">
	    	<select id="chg_meter"></select>
	    	</td>
	    	<td class="tdr" width="10%">更换类型:</td><td class="tdrn">
