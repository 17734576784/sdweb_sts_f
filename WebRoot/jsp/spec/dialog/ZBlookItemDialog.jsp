...
<link rel="STYLESHEET" type="text/css" href="<%=basePath%>css/zh/dhtmlx/dhtmlxgrid.css">
  ...
  <script src="<%=basePath%>js/spec/dialog/ZBlookItemDialog.js"></script>
  ...
  <table class="tabsty" align="center">
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;" width="131px"><label for="<%=i%>">总加组名称</label></td> 
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">基本费</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">费率方案1</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">费率方案2</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">费率方案3</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>     
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">所属加密机</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">写卡户号</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>     
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="<%=i%>">卡表类型</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j%>" style="width: 16px;"/></td>
    ...
    <tr>
      <td colspan="6" style="font-size: 12px;background: url('<%=basePath%>images/bg22.gif') repeat-x;"><table cellpadding="0" cellspacing="0">
          <tr>
            <td style="border: 0px;"><img src="<%=basePath%>images/doctitle.png" style="padding-top: 3px;"/></td>
            <td style="border: 0px; font-size: 12px;">控制信息<label for="yffcs_kzxx_selAll">******全选</label>&nbsp;<input type="checkbox" id="yffcs_kzxx_selAll" style="width: 16px;"/></td>
          </tr>
        </table></td>
    </tr>        
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">脉冲闭合时间</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">启用高负荷控制</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">连续高负荷时间</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>  
    
  
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i%>">高负荷断电值</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j%>" style="width: 16px;"/></td>
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">功率因数标准</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">力调算费标志</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">奖罚标志</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>
         
         
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">报停标志</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">报停开始日期</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">报停结束日期</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>     
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">抄表日</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">抄表日结算标志</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">基本费更改标志</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>
     
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i%>">基本率更改内容</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j%>" style="width: 16px;"/></td>
  ...
  <table class="tabsty" align="center">   
   <tr>
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">购电量-表码差</b></label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">报警值1&2</b></label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>    
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">换表时间</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">开户日期</b></label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i%>"><b style="color:#800000">销户日期</b></label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j%>" style="width: 16px;"/></td>
    </tr>  
    <%int part2_1 = i;
      i=601;
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">结算无功表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>       
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="<%=i%>">算费无功表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j%>" style="width: 16px;"/></td>
    </tr>
    <%int part2_2 = i;
      i=701;
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">总电费</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">电度电费</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">基本费电费</b></label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>     
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>"><b style="color:#800000">力调电费</b></label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">其他电费</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>

    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">追补有功电量</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">追补无功电量</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">实际功率因数</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr> 


    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">累计有功电量</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">累计无功电量</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">追补电度电费</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">追补基本费</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    ...
    <tr>
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">报警1状态</label></td>
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">报警2状态</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="<%=i++%>">分合闸状态</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="<%=j++%>" style="width: 16px;"/></td>
    </tr>
