...
<link rel="STYLESHEET" type="text/css" href="<%=basePath%>css/zh/dhtmlx/dhtmlxgrid.css">
  ...
  <script src="<%=basePath%>js/spec/dialog/fxdfLookItemDialog.js"></script>
  ...
  <table class="tabsty" align="center">
    ...
    <tr>
      <td style="text-align: left; border-right: none;" width="131px"><label for="1"><b style="color:#800000">终端名称</b></label></td>
      <td style="border-left: none;"><input checked="checked" disabled="disabled" type="checkbox" id="1" style="width: 16px; color: red;"/></td>
      
      <td style="text-align: left; border-right: none;" width="131px"><label for="2"><b style="color:#800000">营业户号</b></label></td> 
      <td style="border-left: none;"><input checked="checked" disabled="disabled" type="checkbox" id="2" style="width: 16px; color: red;"/></td>
      
      <td style="text-align: left; border-right: none;" width="131px"><label for="3">总加组名称</label></td> 
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: none;"><label for="11">实际功率因数</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="11" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="12"><b style="color:#800000">电度电费</b> </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="12" style="width: 16px;"/></td>
    </tr>     
   <tr>
      <td style="text-align: left; border-right: none;"><label for="13"><b style="color:#800000">基本费电费</b> </label></td>
      <td style="border-left: none;"><input type="checkbox" id="13" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="14"><b style="color:#800000">力调电费</b> </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="14" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="15">其他电费</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="15" style="width: 16px;"/></td>
    </tr>  
   <tr>
      <td style="text-align: left; border-right: none;"><label for="16"><b style="color:#800000">有功追补累计用电量</b> </label></td>
      <td style="border-left: none;"><input type="checkbox" id="16" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="17">无功追补累计用电量 </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="17" style="width: 16px;"/></td>
      <td colspan =2 ></td>
<!--      <td style="text-align: left; border-right: none;"><label for="10"></label></td> -->
<!--      <td style="border-left: none;"><input type="checkbox" id="10" style="width: 16px;"/></td>-->
    </tr>  
    <tr>
      <td style="text-align: left; border-right: none;"><label for="18">有功累计用电量</label></td>
      <td style="border-left: none;"><input type="checkbox" id="18" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="19">无功累计用电量 </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="19" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="23">断电值/断电金额 </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="23" style="width: 16px;"/></td>
    </tr>  
    <tr>
      <td style="text-align: left; border-right: none;"><label for="20">追补电度电费</label></td>
      <td style="border-left: none;"><input type="checkbox" id="20" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="21">追补基本费电费 </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="21" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="22">追补其它电费 </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="22" style="width: 16px;"/></td>
    </tr>  
    <tr>
      <td style="text-align: left; border-right: none;"><label for="62">更新次数</label></td>
      <td style="border-left: none;"><input type="checkbox" id="62" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="63">整月标志 </label></td> 
      <td style="border-left: none;"><input type="checkbox" id="63" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="64">操作员</label></td> 
...
<!--    </tr>  -->
  ...
  <table class="tabsty" align="center">   
   ...
   <tr>
    ...
    <tr>
      <td style="text-align: left; border-right: none;" width="131px"><label for="24"><b style="color:#800000">上次结算时间</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="24" style="width: 16px;"/></td>
      <td colspan=2 ></td>  <td colspan=2 ></td>
    </tr>    
    <tr>
      <td style="text-align: left; border-right: none;"><label for="25"><b style="color:#800000">上次结算总表底</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="25" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="31">动力关联1上次结算总表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="31" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="37">动力关联2上次结算总表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="37" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="26">上次结算尖表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="26" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="32">动力关联1上次结算尖表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="32" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="38">动力关联2上次结算尖表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="38" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="27">上次结算峰表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="27" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="33">动力关联1上次结算峰表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="33" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="39">动力关联2上次结算峰表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="39" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="28">上次结算平表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="28" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="34">动力关联1上次结算平表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="34" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="40">动力关联2上次结算平表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="40" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="29">上次结算谷表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="29" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="35">动力关联1上次结算谷表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="35" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="41">动力关联2上次结算谷表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="41" style="width: 16px;"/></td>
    </tr>    
	 <tr>
      <td style="text-align: left; border-right: none;"><label for="30"><b style="color:#800000">上次结算无功总表底</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="30" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="36">动力关联1上次结算无功总表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="36" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="42">动力关联2上次结算无功总表底</label></td> 
   ...
   <tr>
    ...
    <tr>
      <td style="text-align: left; border-right: none;" width="131px"><label for="43"><b style="color:#800000">算费表底时间</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="43" style="width: 16px;"/></td>
      <td colspan=2 ></td>  <td colspan=2 ></td>
    </tr>    
    <tr>
      <td style="text-align: left; border-right: none;"><label for="44"><b style="color:#800000">算费表底总表底</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="44" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="50">动力关联1算费表底总表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="50" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="56">动力关联2算费表底总表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="56" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="45">算费表底尖表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="45" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="51">动力关联1算费表底尖表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="51" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="57">动力关联2算费表底尖表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="57" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="46">算费表底峰表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="46" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="52">动力关联1算费表底峰表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="52" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="58">动力关联2算费表底峰表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="58" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="47">算费表底平表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="47" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="53">动力关联1算费表底平表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="53" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="59">动力关联2算费表底平表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="59" style="width: 16px;"/></td>
    </tr>    
	<tr>
      <td style="text-align: left; border-right: none;"><label for="48">算费表底谷表底</label></td>
      <td style="border-left: none;"><input type="checkbox" id="48" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="54">动力关联1算费表底谷表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="54" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="60">动力关联2算费表底谷表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="60" style="width: 16px;"/></td>
    </tr> 
    <tr>
      <td style="text-align: left; border-right: none;"><label for="49"><b style="color:#800000">算费表底无功总表底</b></label></td>
      <td style="border-left: none;"><input type="checkbox" id="49" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="55">动力关联1算费表底无功总表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="55" style="width: 16px;"/></td>
      
      <td style="text-align: left; border-right: none;"><label for="61">动力关联2算费表底无功总表底</label></td> 
      <td style="border-left: none;"><input type="checkbox" id="61" style="width: 16px;"/></td>
    </tr>  
  </table>
  </div>
