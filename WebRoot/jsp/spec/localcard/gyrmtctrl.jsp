...
<html>
	<head>
		...
		<script  src="<%=basePath%>js/spec/localcard/gyrmtctrl.js"></script>
...
//	var sel_type = "<%=request.getParameter("type")%>";
	...
	var SDDef = {};
	SDDef.YFF_CTRLTYPE_GY_LK				= <%=com.kesd.common.SDDef.YFF_CTRLTYPE_GY_LK%>;	//轮次控制
