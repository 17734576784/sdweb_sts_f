...
<html>
  <head>
    ...
    <style type="text/css">
		...
		<script  src="<%=basePath%>js/spec/localcard/gychgrate.js"></script>
  ...
  <body>
    <table id="tabinfo" class="tabinfo" align="center">
    	...
    	<tr>
	    	<td class="tdr" width="12%">客户编号:</td><td id="userno"  width="18%">&nbsp;</td>
	    	<td class="tdr" width="12%">客户名称:</td><td id="username" width="28%">&nbsp;</td>
	     	<td class="tdr" width="12%">客户状态:</td><td id="cus_state" width="18%">&nbsp;</td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	    	<td class="tdr">费控单元:</td><td colspan="5" id="fee_unit">&nbsp;</td>
	    </tr>
   		<tr>
		...
		<tr><td colspan="6" style="height:10px; border: 0px;"></td></tr>
        <tr><td class="td_lable" >新费率</td></tr>
        <tr>
