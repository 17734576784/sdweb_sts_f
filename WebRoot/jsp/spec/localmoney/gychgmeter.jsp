...
<html>
	<head>
		...
		<script  src="<%=basePath%>js/spec/localmoney/gychgmeter.js"></script>
	...
	<table id="tabinfo" class="tabinfo" align="center">
    	...
    	<tr>
   		...
   		<tr>
	    	<td class="tdr" width="15%">客户编号:</td><td id="userno"  width="17%">&nbsp;</td>
	...
	<table id="tabinfo2" class="tabinfo" align="center">
	    ...
	    <tr>
	    	<td class="tdr" width="140">剩余金额(元):</td><td class="tdrn" width="220"><input id="syje" /></td>		  		        		    				
