...
<html>
  <head>
	...
	<script  src="<%=basePath%>js/spec/localmoney/gydestroycus.js"></script>
  ...
  <table id="tabinfo" class="tabinfo" align="center">
	...
	<tr><td colspan="6" style="height:10px; border: 0px;"></td></tr>
    	<tr>
    		<td class="td_lable" style="height:25px;width:140px;"><i18n:message key="baseInfo.bdxx"/></td>
	    ...
	    <tr>
	    	<td class="tdr" width="140" style="height:25px;"><i18n:message key="baseInfo.bdVal"/></td>
