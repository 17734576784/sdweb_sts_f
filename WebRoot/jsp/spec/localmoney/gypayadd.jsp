...
<html>
  <head>
	...
	<script  src="<%=basePath%>js/spec/localmoney/gypayadd.js"></script>
...
<!--    	<tr id="ctrlpara_title"><td class="td_lable">控制参数</td></tr>-->
...
<!--	    <tr id="ctrlpara_butt"><td colspan="6" style="height:8px; border-left: 0px;border-right: 0px;border-bottom: 0px;"></td></tr>	    -->
	...
	<table id="tabinfo2" class="tabinfo" align="center">
	  ...
	  -->
	  <table id="tabinfo2" class="tabinfo" align="center">
	   <tr id='kh_bd1'><td colspan="6" style="height:10px; border: 0px;" ></td></tr>
       <tr id='kh_bd2' ><td class="td_lable" style="height:25px;" ><i18n:message key="baseInfo.bdxx"/></td>
	       <td style="padding-left:10px; border: 0px;">
	       <button id="btnImportBD" class="btn"  disabled="disabled"><i18n:message key="btn.luru"/></button>&nbsp;&nbsp;&nbsp;&nbsp;
	       </td>
	   </tr>
	   <tr id='kh_bd3'>
	    ...
	    <tr id="tr_kh" style="display: none;"><td></td><td></td>
		...
		<tr><td colspan="6" style="text-align: right;border: 0;">
	    	...
	    	<button id="btnPay"  	class="btn"  disabled="disabled">补记录</button>&nbsp;&nbsp;&nbsp;&nbsp;
