...
<html>
  <head>
	...
	<script  src="<%=basePath%>js/spec/localmoney/gyrever.js"></script>
  ...
  <body>
	...
	<table id="tabinfo2" class="tabinfo" align="center">
	    ...
	    <tr>
	    	<td class="tdr" width="140">上次缴费金额(元):</td><td class="tdrn"><input id="last_je" readonly style="background: #ccc;" /></td>
	    	<td class="tdr" width="140">上次追补金额(元):</td><td class="tdrn"><input id="last_zbje" readonly style="background: #ccc;" /></td>
	    	<td class="tdr" width="140">上次结算金额(元):</td><td class="tdrn"><input id="last_jsje" readonly style="background: #ccc;" /></td>
	    	<td class="tdr" width="140">上次总金额(元):</td><td class="tdrn"><input id="last_tt" readonly style="background: #ccc;"/></td>		  		        		    				
	    </tr>
	    <tr>
	    	...
	    	<td class="tdr">实际总金额(元):</td><td class="tdrn"><input id="zje" readonly style="background: #ccc;"/></td>
	    </tr>
	    <tr>
