...
<html>
  ...
  <body>
    <form id="frmfile" name="frmfile" style="display: inline" action ="<%=basePath%>excel/fileUploadNPK.action" method ="POST" ENCTYPE="multipart/form-data">
  ...
  <script src="<%=basePath%>js/docs/yffparapl_npk.js"></script>
</html>
