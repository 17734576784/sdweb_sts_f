...
<html>
  <head>
    ...
    <title>My JSP 'yffparaz.jsp' starting page</title>
    <style type="text/css">
body {
	margin:0 0 0 0;
	overflow:hidden;
...
<link rel="STYLESHEET" type="text/css" href="<%=basePath%>css/zh/dhtmlx/dhtmlxgrid.css">
  ...
  <script src="<%=basePath%>js/docs/yffpara_spec.js"></script>
  ...
  <jsp:include page="../tree.jsp">
  	<jsp:param name="autoshow_type" value="spec_doc"/>
  </jsp:include>
  </td>
  <td>
...
<SCRIPT>
	var grid_title = "<i18n:message key="page.spec.fkcs.title" />";
