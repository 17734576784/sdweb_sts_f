...
<html>
  <head>
    <title>My JSP 'yffparapl.jsp' starting page</title>
    <style type="text/css">
body {
	margin:0 0 0 0;
	overflow:hidden;
...
<link rel="STYLESHEET" type="text/css" href="<%=basePath%>css/zh/dhtmlx/dhtmlxgrid.css">
  ...
  <script src="<%=basePath%>js/docs/yffparapl_np.js"></script>
  ...
  <!-- 页面初始自动加载查询参数: dy_doc，spec_doc，np_doc-->
  <jsp:include page="../tree.jsp">
  	<jsp:param value="np_doc" name="autoshow_type"/>
  </jsp:include>
  </td>
  <td>
<table cellpadding="0" cellspacing="0" height="24" width="100%" class="page_tbl_bg22">
  <tr>
    <td>&nbsp;<i18n:message key="doc.fkdbmc" />: 
...
<SCRIPT>
	var grid_title = "<i18n:message key="page.np.fkpl.grid_title" />";
	var update_cond = "<i18n:message key="comm.gridopt.update_cond" />";
