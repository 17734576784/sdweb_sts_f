...
<html>
  <head>
    ...
    <title>My JSP 'yffparazpl.jsp' starting page</title>
    <style type="text/css">
body {
	margin:0 0 0 0;
	overflow:hidden;
...
<link rel="STYLESHEET" type="text/css" href="<%=basePath%>css/zh/dhtmlx/dhtmlxgrid.css">
  ...
  <script src="<%=basePath%>js/docs/yffparapl_spec.js"></script>
  ...
  <jsp:include page="../tree.jsp">
  	<jsp:param value="spec_doc" name="autoshow_type"/>
  </jsp:include>
  </td>
  <td>
...
<SCRIPT>
	var grid_title = "<i18n:message key="page.spec.fkpl.title" />";
