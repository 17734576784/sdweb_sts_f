...
<html>
  ...
  <script type="text/javascript" src="<%=basePath%>js/docs/importResidentArchive.js"></script>
  ...
  <td>
   	<table cellpadding="0" cellspacing="0" height="24" width="100%" class="page_tbl_bg22">
  		<tr>
  			<td width=10></td>
            <td style="float: left;width=150">
            <form id="formResidentData" method="post" action="<%=basePath%>ajax/actImportResidentData.action" name ="excels" enctype="multipart/form-data">
